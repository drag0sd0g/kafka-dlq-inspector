package com.example.kafkainspector.config
...
class KafkaConfig(
    ...
    fun consumerFactory(): ConsumerFactory<ByteArray, ByteArray> {
        val config = properties.buildConsumerProperties(sslBundles).toMutableMap()
    ...
    @Bean
    fun errorHandler(): CommonErrorHandler = DefaultErrorHandler(null, Duration.ofSeconds(5))
